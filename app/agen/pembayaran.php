...
//kode otomatis
	$hari_ini = date("Ymd");
	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id_pembayaran FROM pembayaran WHERE id_pembayaran LIKE '%$hari_ini%' order by id_pembayaran DESC");
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-hover">
												...
												<tbody>
													...
													<?php } }
														@$sql_total = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(jumlah_bayar) as 'sum_bayar' FROM tagihan WHERE id_pelanggan = '$id_pelanggan' AND status = 'Belum Bayar'");
