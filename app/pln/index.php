...
<body style="background:url('../images/newbg.png');">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="panel panel-primary">
						...
						<div class="panel-footer">
							<center>
								<strong>&copy;<script>document.write(new Date().getFullYear());</script> - Rakasiwi Akbar(<a href="https://www.instagram.com/xyz_zxca/">Rakasiwi Akbar</a>)
							</center>
						</div>
						<!-- end footer -->
					</div>
